<section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-user"></i> Graduate School</h3>
        <!-- /row -->
        <div class="row mt">
          <div class="col-lg-12">
          <?php
            ...
            <div class="form-panel" style="border-radius:20px;">
              ...
              <?=form_open(base_url()."save_graduate_school",array("class" => "form-horizontal style-form"));?>              
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">College/University Graduated:</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control round-form" name="tertiary" value="<?=$profile['college'];?>" required>
                  </div>
                </div>
                <div class="form-group">
