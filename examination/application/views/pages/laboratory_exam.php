<section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Laboratory Examination</h3>
        <!-- /row -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel">
              ...
              <tr>
                <td colspan="4"><b>Test I. Identification.</b> Identify the following questions. Select your answer from the choices below.</td>
              </tr>
              <?php
                $x=1;
                ...
                ?>                
                <tr>
                <td colspan="4"><b>Test II. True or False.</b></td>
              </tr>
              <?php
                $x=1;
                foreach($truefalse AS $item){
                    ...
                    echo "</tr>";
                    echo "<tr>";                        
                        echo "<td colspan='4'><input type='radio' name='b$x' value='True'> True<br><input type='radio' name='b$x' value='False'> False</td>";
                    echo "</tr>";
                    $x++;
                }
                ?>                
                <tr>
                <td colspan="4"><b>Test III. Multiple Choice.</b> Select your answer from the choices below.</td>
              </tr>
              <?php
                $x=1;
                foreach($multiplechoice AS $item){
                    ...
                    echo "</tr>";
                    echo "<tr>";
                        echo "<td align='left'><input type='radio' name='c$x' value='$item[c1]'> $item[c1]<br><input type='radio' name='c$x' value='$item[c2]'> $item[c2]<br><input type='radio' name='c$x' value='$item[c3]'> $item[c3]<br><input type='radio' name='c$x' value='$item[c4]'> $item[c4]</td>";
                    echo "</tr>";
                    $x++;
                }
                ?>
...
<?php
$examtime=$this->Exam_model->getExamTime($username,"LABORATORY");
?>
<script>
