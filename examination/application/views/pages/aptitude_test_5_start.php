        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> Test V
              ...
              <input type="hidden" name="testno" value="5">
              ...
              <table class="table" style="font-size:14px;">
                ...
                foreach($items AS $item){
                    if($item['q1']==""){
                        $desc="<b>In the items below, select the option which should appear first alphabetically.</b>";
                    }else{
                        $desc="";
                    }
                    ...
                    if($item['q1']==""){
                        $desc="<b>In the items below, select the option which should appear first alphabetically.</b>";
                        echo "<tr>";
                            echo "<td colspan='4'><b>$x. $desc</b></td>";
                        echo "</tr>";
                    }else{
                        echo "<tr>";
...
<?php
$examtime=$this->Exam_model->getExamTime($username,"5");
?>
<script>
