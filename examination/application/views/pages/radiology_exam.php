<section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Radiology Examination</h3>
        <!-- /row -->
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel">
              ...
              <table class="display table" style="font-size:20px;">                             
                <tr>
                <td colspan="4"><b>Test I. Multiple Choice.</b> Select your answer from the choices below.</td>
              </tr>
              <?php
                $x=1;
                ...
                ?>
                <tr>
                <td colspan="4"><b>Part II. Essay</b></td>
              </tr>
                <?php
                $x=1;
